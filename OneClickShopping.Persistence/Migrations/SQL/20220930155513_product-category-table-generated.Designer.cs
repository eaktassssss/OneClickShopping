...
namespace OneClickShopping.Persistence.Migrations.SQL
{
    ...
    [Migration("20220930155513_product-category-table-generated")]
    partial class productcategorytablegenerated
    {
            ...
            modelBuilder.Entity("OneClickShopping.Domain.Entities.Products", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 9, 30, 18, 55, 13, 741, DateTimeKind.Local).AddTicks(8725));
